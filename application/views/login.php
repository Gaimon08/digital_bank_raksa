              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  <span class="app-brand-logo demo">
                    <img src="<?=base_url()?>assets/login/assets/img/illustrations/logo1.png" alt="" class="src" width="170" height="160">
                  </span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Selamat Datang  E-Digital bank  </h4>
              <p class="mb-4">Tolong login terlebih dahulu sebelum masuk sistem !</p>

              <form  class="mb-3" action="<?=site_url('auth/process')?>" method="POST">
                <div class="mb-3">
