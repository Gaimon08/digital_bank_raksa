...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Tambah Kredit Pegawai
      <small>it all starts here</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li><a href="#">Kredit Pegawai</a></li>
      <li class="active">Tambah Kredit Pegawai</li>
    </ol>
  </section>
  ...
  <section class="content">
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <form method="post" action="<?php echo site_url() . 'Kredit_pegawai/simpan'; ?>" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="jenis_agunan">
              ...
              <option value="Sertifikat Pendidik">Sertifikat Tanah dan atau Bangunan</option>
            </select>
