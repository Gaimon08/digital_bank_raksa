...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Edit Data KAB</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <form method="post" action="<?php echo site_url() . 'Kredit_KAB/update'; ?>" enctype="multipart/form-data">
                    <input type="hidden" name="id_KAB" value="<?= $pengajuan_kredit->id_KAB; ?>">
