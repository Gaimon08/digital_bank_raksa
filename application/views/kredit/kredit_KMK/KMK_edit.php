...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Edit Data Kredit KMK
            <small>it all starts here</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Kredit KMK</a></li>
            <li class="active">Edit Data KMK</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <form method="post" action="<?php echo base_url() . 'Kredit_KMK/update'; ?>" enctype="multipart/form-data">
                    <input type="hidden" name="id_KMK" value="<?= $pengajuan_kredit->id_KMK; ?>">
